...
<div class="row">
    <div class="col-md-8">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{route('books.update', [$book->id])}}" class="p-3 shadow-sm bg-white">
            ...
            <input placeholder="Author" value="{{ old('author') ? old('author') : $book->author}}" type="text" id="author" name="author"
            ...
            <input class="form-control {{$errors->first('publisher') ? "isinvalid" : "" }}" type="text"
                placeholder="Publisher" name="publisher" id="publisher" value="{{ old('publisher') ? old('publisher') :$book->publisher}}">
            <div class="invalid-feedback">
